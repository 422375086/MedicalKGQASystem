...
class QuestionClassifier(object):
	def __init__(self):
		...
		# 特征词路径 需修改为文件所在自己电脑的路径
		self.disease_path = os.path.join('D:/MedicalKGQA-master/region_words/diseases.txt')
		self.department_path = os.path.join('D:/MedicalKGQA-master/region_words/departments.txt')
		self.check_path = os.path.join('D:/MedicalKGQA-master/region_words/checks.txt')
		self.drug_path = os.path.join('D:/MedicalKGQA-master/region_words/drugs.txt')
		self.food_path = os.path.join('D:/MedicalKGQA-master/region_words/foods.txt')
		self.symptom_path = os.path.join('D:/MedicalKGQA-master/region_words/symptoms.txt')
		self.deny_path = os.path.join('D:/MedicalKGQA-master/region_words/deny.txt')
